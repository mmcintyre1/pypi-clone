...
cp /apps/pypi_org/server/pypi.service /etc/systemd/system/pypi.service
...
cp /apps/pypi_org/server/pypi.nginx /etc/nginx/sites-enabled/pypi.nginx
...
certbot --nginx -d silentlyfailing.com